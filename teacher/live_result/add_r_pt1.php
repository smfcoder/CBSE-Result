...
<?php
    ...
    if(isset($_POST['submit']))
    {
            ...
            $tm_pt1=($english+$hindi+$maths+$science+$sst);
            $per_pt1=(($tm_pt1)/2.5);
            ...
            $fetch="UPDATE result SET englishpt1='".$english."', hindipt1='".$hindi."', mathspt1='".$maths."',sciencept1='".$science."',sstpt1='".$sst."',tm_pt1='".$tm_pt1."',per_pt1='".$per_pt1."' , itpt1='".$it."'   WHERE  sid = '".$uni."'  ";
            $fet="UPDATE student SET pt1_s='".$val."'   WHERE  id = '".$unid."'  ";
            //best of 3 code
                    $my_pt="SELECT * FROM result WHERE  sid = '".$uni."' ;";
                    $q=mysqli_query($sql,$my_pt);
                    $row=mysqli_fetch_array($q);
                    $english_pt3= $row['englishpt3'];
                    $english_pt2=$row['englishpt2'];
                    $english_pt1=$english;
                    $hindi_pt3=$row['hindipt3'];
                    $hindi_pt2=$row['hindipt2'];
	                $hindi_pt1=$hindi;
	                $maths_pt3=$row['mathspt3'];
	                $maths_pt2=$row['mathspt2'];
	                $maths_pt1=$maths;
	                $science_pt3=$row['sciencept3'];
	                $science_pt2=$row['sciencept2'];
	                $science_pt1=$science;
	                $sst_pt3=$row['sstpt3'];
	                $sst_pt2=$row['sstpt2'];
	                $sst_pt1=$sst;
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>ENTER MARKS OF PERIODIC TEST 1</a>
          </li>
        </ol>
        <?php
        ...
        <form method="POST" action="add_r_pt1.php">
        ...
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">English</label>
            <div class="col-sm-11">
              <input type="number"  max='50' min='0'  name="english"  class="form-control" placeholder="English" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Hindi</label>
            <div class="col-sm-11">
              <input type="number"  max='50' min='0' name="hindi" class="form-control" placeholder="Hindi" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Maths</label>
            <div class="col-sm-11">
              <input type="number" max='50' min='0' name="maths" class="form-control" placeholder="Maths" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Science</label>
            <div class="col-sm-11">
              <input type="number" max='50' min='0' class="form-control" name="science" placeholder="Science" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">SST</label>
            <div class="col-sm-11">
              <input type="number" max='50' min='0' name="sst" class="form-control" placeholder="SST" required>
            </div>
        </div>
        
         <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">IT</label>
            <div class="col-sm-11">
              <input type="number" max='50' min='0' name="it" class="form-control" placeholder="IT" required>
            </div>
        </div>

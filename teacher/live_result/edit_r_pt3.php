...
<?php
    ...
    if(isset($_POST['submit']))
    {
                    ...
                    $fetch="UPDATE result SET englishpt3='".$english."', hindipt3='".$hindi."', mathspt3='".$maths."',sciencept3='".$science."',sstpt3='".$sst."',itpt3='".$it."'   WHERE  sid = '".$uni."'  ";
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>EDIT MARKS OF PERIODIC TEST 3</a>
          </li>
        </ol>
        ...
        ?>
        <form method="POST" action="edit_r_pt3.php">
            
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">English</label>
            <div class="col-sm-10">
              <input type="number" step=any  max='50' min='0'  name="english" value="<?php echo $row_r['englishpt3'];?>" class="form-control" placeholder="English" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Hindi</label>
            <div class="col-sm-10">
              <input type="number" step=any  max='50' min='0' name="hindi" value="<?php echo $row_r['hindipt3'];?>" class="form-control" placeholder="Hindi" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Maths</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' name="maths" value="<?php echo $row_r['mathspt3'];?>" class="form-control" placeholder="Maths" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Science</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' class="form-control" value="<?php echo $row_r['sciencept3'];?>" name="science" placeholder="Science" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">SST</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' name="sst" value="<?php echo $row_r['sstpt3'];?>" class="form-control" placeholder="SST" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">IT</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' name="it" value="<?php echo $row_r['itpt3'];?>" class="form-control" placeholder="SST" required>
            </div>
        </div>

...
<?php
    ...
    if(isset($_POST['submit']))
    {
                    ...
                    $fet="UPDATE student SET pt3_s='".$val."'   WHERE  id = '".$unid."'  ";
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>ENTER MARKS OF PERIODIC TEST 3</a>
          </li>
        </ol>
        ...
        <form method="POST" action="add_r_pt3.php">
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">English</label>
            <div class="col-sm-10">
              <input type="number" step=any  max='50' min='0'  name="english"  class="form-control" placeholder="English" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Hindi</label>
            <div class="col-sm-10">
              <input type="number" step=any  max='50' min='0' name="hindi" class="form-control" placeholder="Hindi" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Maths</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' name="maths" class="form-control" placeholder="Maths" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Science</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' class="form-control" name="science" placeholder="Science" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">SST</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' name="sst" class="form-control" placeholder="SST" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' name="it" class="form-control" placeholder="IT" required>
            </div>
        </div>

...
<?php
    ...
    if(isset($_POST['submit']))
    {
            ...
            $fetch="UPDATE result SET englishpt1='".$english."', hindipt1='".$hindi."', mathspt1='".$maths."',sciencept1='".$science."',sstpt1='".$sst."',itpt1='".$it."',tm_pt1='".$tm_pt1."',per_pt1='".$per_pt1."'   WHERE  sid = '".$uni."'  ";
            //best of 3 code
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>EDIT MARKS OF PERIODIC TEST 1</a>
          </li>
        </ol>
        ...
        ?>
        <form method="POST" action="edit_r_pt1.php">
            
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">English</label>
            <div class="col-sm-10">
              <input type="number" step=any  max='50' min='0'  name="english" value="<?php echo $row_r['englishpt1'];?>" class="form-control" placeholder="English" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Hindi</label>
            <div class="col-sm-10">
              <input type="number" step=any  max='50' min='0' name="hindi" value="<?php echo $row_r['hindipt1'];?>" class="form-control" placeholder="Hindi" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Maths</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' name="maths" value="<?php echo $row_r['mathspt1'];?>" class="form-control" placeholder="Maths" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Science</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' class="form-control" value="<?php echo $row_r['sciencept1'];?>" name="science" placeholder="Science" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">SST</label>
            <div class="col-sm-10">
              <input type="number" step=any max='50' min='0' name="sst" value="<?php echo $row_r['sstpt1'];?>" class="form-control" placeholder="SST" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="number" max='50' min='0' name="it" value="<?php echo $row_r['itpt1'];?>" class="form-control" placeholder="IT" required>
            </div>
        </div>

...
<?php
    ...
    if(isset($_POST['submit']))
    {
            ...
            $fet="UPDATE student SET ses_s='".$val."'   WHERE  id = '".$unid."'  ";
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>ENTER MARKS OF SESSIONAL ASSESMENT</a>
          </li>
        </ol>
        <?php
        ...
        <form method="POST" action="add_r_extsub.php">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0'  name="english_se"  class="form-control" placeholder="Subject Enrichment" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Portfolio</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0' name="english_p" class="form-control" placeholder="Portfolio" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Notebook</label>
            <div class="col-sm-11">
              <input type="number" step=any max='5' min='0' name="english_n" class="form-control" placeholder="Notebook" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Subject Enrichment</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0'  name="hindi_se"  class="form-control" placeholder="Subject Enrichment" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Portfolio</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0' name="hindi_p" class="form-control" placeholder="Portfolio" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Notebook</label>
            <div class="col-sm-11">
              <input type="number" step=any max='5' min='0' name="hindi_n" class="form-control" placeholder="Notebook" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Subject Enrichment</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0'  name="maths_se"  class="form-control" placeholder="Subject Enrichment" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Portfolio</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0' name="maths_p" class="form-control" placeholder="Portfolio" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Notebook</label>
            <div class="col-sm-11">
              <input type="number" step=any max='5' min='0' name="maths_n" class="form-control" placeholder="Notebook" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Subject Enrichment</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0'  name="science_se"  class="form-control" placeholder="Subject Enrichment" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Portfolio</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0' name="science_p" class="form-control" placeholder="Portfolio" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Notebook</label>
            <div class="col-sm-11">
              <input type="number" step=any max='5' min='0' name="science_n" class="form-control" placeholder="Notebook" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Subject Enrichment</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0'  name="sst_se"  class="form-control" placeholder="Subject Enrichment" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Portfolio</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0' name="sst_p" class="form-control" placeholder="Portfolio" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Notebook</label>
            <div class="col-sm-11">
              <input type="number" step=any max='5' min='0' name="sst_n" class="form-control" placeholder="Notebook" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Subject Enrichment</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0'  name="it_se"  class="form-control" placeholder="Subject Enrichment" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Portfolio</label>
            <div class="col-sm-11">
              <input type="number" step=any  max='5' min='0' name="it_p" class="form-control" placeholder="Portfolio" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-1 col-form-label">Notebook</label>
            <div class="col-sm-11">
              <input type="number" step=any max='5' min='0' name="it_n" class="form-control" placeholder="Notebook" required>
            </div>
        </div>

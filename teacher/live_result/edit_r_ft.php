  ...
  ?>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        ?>
        <form method="POST" action="edit_r_ft.php">
            
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">English</label>
            <div class="col-sm-10">
              <input type="number" step=any  max='80' min='0'  name="english" value="<?php echo $row_r['englishft'];?>" class="form-control" placeholder="English" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Hindi</label>
            <div class="col-sm-10">
              <input type="number" step=any  max='80' min='0' name="hindi" value="<?php echo $row_r['hindift'];?>" class="form-control" placeholder="Hindi" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Maths</label>
            <div class="col-sm-10">
              <input type="number" step=any max='80' min='0' name="maths" value="<?php echo $row_r['mathsft'];?>" class="form-control" placeholder="Maths" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Science</label>
            <div class="col-sm-10">
              <input type="number" step=any max='80' min='0' class="form-control" value="<?php echo $row_r['scienceft'];?>" name="science" placeholder="Science" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">SST</label>
            <div class="col-sm-10">
              <input type="number" step=any max='80' min='0' name="sst" value="<?php echo $row_r['sstft'];?>" class="form-control" placeholder="SST" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">IT</label>
            <div class="col-sm-10">
              <input type="number" step=any max='80' min='0' name="it" value="<?php echo $row_r['itft'];?>" class="form-control" placeholder="SST" required>
            </div>
        </div>

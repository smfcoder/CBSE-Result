                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center" style="padding: 10px;"><u> Periodic Test 1 </u></h2>
                                </div>
                            </div>
                            <!-- /.row -->
                        ...
                        <?php
                            ...
                            $eng= $row_r['englishpt1'];
                            $hindi =$row_r['hindipt1'];
                            $maths =$row_r['mathspt1'];
                            $science =$row_r['sciencept1'];
                            $sst =$row_r['sstpt1'];
                            $it =$row_r['itpt1'];
                            $tm=$row_r['tm_pt1'];
                            $per=$row_r['per_pt1'];

                ...
                <div class="content-container">
                    ...
                    <div class="main-page">
                        ...
                        <?php
                            ...
                            $hindii =$row_r['hindii'];
                            $mathsi =$row_r['mathsi'];
                            $sciencei =$row_r['sciencei'];
                            $ssti =$row_r['ssti'];
                            $iti =$row_r['iti'];
                            
                            $engft= $row_r['englishft'];
                            $hindift =$row_r['hindift'];
                            $mathsft =$row_r['mathsft'];
                            $scienceft =$row_r['scienceft'];
                            $sstft =$row_r['sstft'];
                            $itft =$row_r['itft'];
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <tbody>
                                                		<tr>
                                                            ...
                                                            <td style="text-align: center"><?php echo $engi; ?></td>
                                                            <td style="text-align: center"><?php echo $engft; ?></td>
                                                            <td style="text-align: center"><?php echo $eng; ?></td>
                                                		</tr>
                                                        	<tr>
                                                            <th scope="row" style="text-align: center">2</th>
                                                            <td style="text-align: center">Hindi</td>
                                                            <td style="text-align: center"><?php echo $hindii; ?></td>
                                                            <td style="text-align: center"><?php echo $hindift; ?></td>
                                                    	...
                                                    	<tr>
                                                            ...
                                                            <td style="text-align: center"><?php echo $mathsi; ?></td>
                                                            <td style="text-align: center"><?php echo $mathsft; ?></td>
	                                                    ...
	                                                    <tr>
                                                            ...
                                                            <td style="text-align: center"><?php echo $sciencei; ?></td>
                                                            <td style="text-align: center"><?php echo $scienceft; ?></td>
	                                                    ...
	                                                    <tr>
                                                            ...
                                                            <td style="text-align: center"><?php echo $ssti; ?></td>
                                                            <td style="text-align: center"><?php echo $sstft; ?></td>
                                                		...
                                                		<tr>
                                                            ...
                                                            <td style="text-align: center"><?php echo $iti; ?></td>
                                                            <td style="text-align: center"><?php echo $itft; ?></td>

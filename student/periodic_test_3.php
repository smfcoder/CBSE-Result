                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center" style="padding: 10px;"><u> Periodic Test 3 </u></h2>
                                </div>
                            </div>
                            <!-- /.row -->
                        ...
                        <?php
                            ...
                            $eng= $row_r['englishpt3'];
                            $hindi =$row_r['hindipt3'];
                            $maths =$row_r['mathspt3'];
                            $science =$row_r['sciencept3'];
                            $sst =$row_r['sstpt3'];
                            $it =$row_r['itpt3'];
                            $tm=$row_r['tm_pt3'];
                            $per=$row_r['per_pt3'];

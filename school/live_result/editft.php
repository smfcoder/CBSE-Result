<?php
    ...
    {
        header('location:../school/school_log.php');
        exit();
    }
?>
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $fetch="UPDATE class SET ft_s='".$status."'  WHERE  id = '".$unique."'  ";
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>ACTIVE/INACTIVE FINAL TEST</a>
          </li>
        </ol>
        <form method="POST" action="editft.php">
